...
########################## Define DFT Signals ##########################
set_dft_signal -type ScanClock -port [get_ports scan_clk] -view existing_dft -timing {30 60}
set_dft_signal -type Reset     -port [get_ports scan_rst] -view existing_dft -active_state 0
set_dft_signal -type Constant  -port [get_ports test_mode] -view existing_dft -active_state 1
set_dft_signal -type TestMode  -port [get_ports test_mode] -view spec -active_state 1
set_dft_signal -type ScanEnable -port [get_ports SE] -view spec -active_state 1
set_dft_signal -type ScanDataIn -port [get_ports SI] -view spec
set_dft_signal -type ScanDataOut -port [get_ports SO] -view spec
