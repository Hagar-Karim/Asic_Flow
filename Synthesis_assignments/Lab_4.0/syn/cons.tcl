...
#set_false_path -from [get_clock CLKA_DOMAIN] -to [get_clock CLKB_DOMAIN]
#set_false_path -from [get_clock CLKB_DOMAIN] -to [get_clock CLKA_DOMAIN]

set_clock_groups -asynchronous -group [get_clock CLKA_DOMAIN] -group [get_clock CLKB_DOMAIN]
